...
public class MerkleParallelTest extends TestCase {
    public static Test suite() {
	return new TestSuite(MerkleParallelTest.class);
    }
     ...
     */
    public MerkleParallelTest(String testName) {
	super(testName);
    }

    public void testMerkleParallel() throws Exception {
